...
package net.mcreator.vanilla_expansion_m.world.dimension;
...
import net.mcreator.vanilla_expansion_m.item.DoomlandsItem;
...
public class DoomlandsDimension extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:doomlands")
	public static final ModDimension dimension = null;
	@ObjectHolder("vannila_expansion_m:doomlands_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DoomlandsDimension(MsVanillaExpansionElements instance) {
		super(instance, 78);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("doomlands"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("vannila_expansion_m:doomlands")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("vannila_expansion_m:doomlands"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("vannila_expansion_m:doomlands"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("vannila_expansion_m:doom")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new DoomlandsItem().setRegistryName("doomlands"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("doomlands_portal");
		}
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos, Blocks.MAGMA_BLOCK.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
