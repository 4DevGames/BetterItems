...
package net.mcreator.vanilla_expansion_m.world.structure;
...
public class JungleHouseStructure extends MsVanillaExpansionElements.ModElement {
	public JungleHouseStructure(MsVanillaExpansionElements instance) {
		super(instance, 45);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 15000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("vannila_expansion_m", "j2"));
						if (template == null)
							return false;
