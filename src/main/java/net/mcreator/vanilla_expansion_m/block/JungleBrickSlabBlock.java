...
public class JungleBrickSlabBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:junglebrickslab")
	public static final Block block = null;
	public JungleBrickSlabBlock(MsVanillaExpansionElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("junglebrickslab");
		}
