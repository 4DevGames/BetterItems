...
public class JunglestoneBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:junglestone")
	public static final Block block = null;
	public JunglestoneBlock(MsVanillaExpansionElements instance) {
		super(instance, 36);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 16), Placement.COUNT_RANGE, new CountRangeConfig(24, 0, 0, 163)));
		}
	}
}
