...
public class JungleBrickWallsBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:junglebrickwalls")
	public static final Block block = null;
	public JungleBrickWallsBlock(MsVanillaExpansionElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("junglebrickwalls");
		}
