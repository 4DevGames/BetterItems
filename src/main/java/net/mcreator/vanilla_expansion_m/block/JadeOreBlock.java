...
import net.mcreator.vanilla_expansion_m.item.JadeGemItem;
...
public class JadeOreBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:jadeore")
	public static final Block block = null;
	public JadeOreBlock(MsVanillaExpansionElements instance) {
		super(instance, 27);
	}
