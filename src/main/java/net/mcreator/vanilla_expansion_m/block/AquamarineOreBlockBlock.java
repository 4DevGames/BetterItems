...
public class AquamarineOreBlockBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:aquamarineoreblock")
	public static final Block block = null;
	public AquamarineOreBlockBlock(MsVanillaExpansionElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aquamarineoreblock");
		}
