...
import net.mcreator.vanilla_expansion_m.item.AquamarineGemItem;
...
public class AquamarineOreBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:aquamarineore")
	public static final Block block = null;
	public AquamarineOreBlock(MsVanillaExpansionElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AquamarineGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("aquamarineore", "aquamarineore", blockAt -> {
