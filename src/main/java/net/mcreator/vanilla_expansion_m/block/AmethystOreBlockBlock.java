...
public class AmethystOreBlockBlock extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:amethystoreblock")
	public static final Block block = null;
	public AmethystOreBlockBlock(MsVanillaExpansionElements instance) {
		super(instance, 2);
	}
