...
import net.mcreator.vanilla_expansion_m.procedures.AmethystAppleFoodEatenProcedure;
import net.mcreator.vanilla_expansion_m.MsVanillaExpansionElements;

@MsVanillaExpansionElements.ModElement.Tag
public class AmethystAppleItem extends MsVanillaExpansionElements.ModElement {
	@ObjectHolder("vannila_expansion_m:amethystapple")
	public static final Item block = null;
	public AmethystAppleItem(MsVanillaExpansionElements instance) {
		super(instance, 22);
	}
