...
import net.mcreator.better_items.procedures.JadeTotemNewRightClickedOnBlockProcedure;
import net.mcreator.better_items.procedures.JadeTotemNewRightClickedInAirProcedure;
import net.mcreator.better_items.BetterItemsElements;

@BetterItemsElements.ModElement.Tag
public class JadeTotemNewItem extends BetterItemsElements.ModElement {
	@ObjectHolder("better_items:jadetotemnew")
	public static final Item block = null;
	public JadeTotemNewItem(BetterItemsElements instance) {
		super(instance, 33);
	}
