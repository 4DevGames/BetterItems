...
public class AmethystSwordItem extends BetterItemsElements.ModElement {
	@ObjectHolder("better_items:amethystsword")
	public static final Item block = null;
	public AmethystSwordItem(BetterItemsElements instance) {
		super(instance, 9);
	}
