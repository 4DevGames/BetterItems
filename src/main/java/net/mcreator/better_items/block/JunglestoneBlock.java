...
public class JunglestoneBlock extends BetterItemsElements.ModElement {
	@ObjectHolder("better_items:junglestone")
	public static final Block block = null;
	public JunglestoneBlock(BetterItemsElements instance) {
		super(instance, 36);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("junglestone", "junglestone", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 16), Placement.COUNT_RANGE, new CountRangeConfig(11, 0, 0, 163)));
		}
	}
}
