...
public class JadeOreBlockBlock extends BetterItemsElements.ModElement {
	@ObjectHolder("better_items:jadeoreblock")
	public static final Block block = null;
	public JadeOreBlockBlock(BetterItemsElements instance) {
		super(instance, 28);
	}
