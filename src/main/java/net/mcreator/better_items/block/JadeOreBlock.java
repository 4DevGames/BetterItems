...
import net.mcreator.better_items.item.JadeGemItem;
...
public class JadeOreBlock extends BetterItemsElements.ModElement {
	@ObjectHolder("better_items:jadeore")
	public static final Block block = null;
	public JadeOreBlock(BetterItemsElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(JadeGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("jadeore", "jadeore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 8), Placement.COUNT_RANGE, new CountRangeConfig(2, 1, 1, 32)));
		}
	}
}
