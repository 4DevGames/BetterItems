...
public class AmethystAppleFoodEatenProcedure extends BetterItemsElements.ModElement {
	public AmethystAppleFoodEatenProcedure(BetterItemsElements instance) {
		super(instance, 22);
	}
